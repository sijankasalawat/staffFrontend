...
const AllEmployees = () => {
  ...
  return (
    <>
    {open &&
          <CreateEmployee open={open} toggle={(val)=>setOpen(val)}/>
    }
      ...
      <div className='w-full flex justify-end mr-3 mt-3 mb-3 '>
        <button className="btn bg-[#8D75F5] text-white p-2 flex gap-2 hover:bg-purple-700 rounded-xl" onClick={() => setOpen(true)}>
          Add Employee
