            ...
            <ul className="space-y-2 font-medium">
              <li>
                <button 
                  ...
                  className={`w-[100%] flex items-center p-2 text-gray-900 rounded-r-lg hover:bg-orange-100 dark:hover:bg-gray-700 group ${activeContainer === 'dashboard' ? 'bg-orange-100 text-[#F97316] border-l-4 border-[#F97316]' : ''}`}
                >
                  <span className={`w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-[#F97316] dark:group-hover:text-white`}>
                    <svg 
                      ...
                      viewBox="0 0 24 24" 
                      fill="currentColor" 
                      className={`w-6 h-6 ${activeContainer === 'dashboard' ? 'text-[#F97316]' : ''}`}
                    >
                      <path 
                        fillRule="evenodd" 
                  ...
                  <div className={`ms-3 ${activeContainer === 'dashboard' ? 'text-[#F97316]' : ''}`}>Dashboard</div>
                </button>
              </li>
              <li>
                <button 
                  onClick={() => handleContainerChange('allEmployees')} 
                  className={`w-[100%] flex items-center p-2 text-gray-900 rounded-r-lg hover:bg-orange-100 dark:hover:bg-gray-700 group ${activeContainer === 'allEmployees' ? 'bg-orange-100 text-[#F97316] border-l-4 border-[#F97316]' : ''}`}
                >
                  <span className={`w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-[#F97316] dark:group-hover:text-white`}>
                    <svg 
                      xmlns="http://www.w3.org/2000/svg" 
                      viewBox="0 0 24 24" 
                      fill="currentColor" 
                      className={`w-6 h-6 ${activeContainer === 'allEmployees' ? 'text-[#F97316]' : ''}`}
                    >
                      <path 
                        fillRule="evenodd" 
                  ...
                  <div className={`ms-3 ${activeContainer === 'allEmployees' ? 'text-[#F97316]' : ''}`}>All Employees</div>
                </button>
              </li>
              <li>
                <button 
                  onClick={() => handleContainerChange('attendance')} 
                  className={`w-[100%] flex items-center p-2 text-gray-900 rounded-r-lg hover:bg-orange-100 dark:hover:bg-gray-700 group ${activeContainer === 'attendance' ? 'bg-orange-100 text-[#F97316] border-l-4 border-[#F97316]' : ''}`}
                >
                  <span className={`w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-[#F97316] dark:group-hover:text-white`}>
                    <svg 
                      xmlns="http://www.w3.org/2000/svg" 
                      viewBox="0 0 24 24" 
                      fill="currentColor" 
                      className={`w-6 h-6 ${activeContainer === 'attendance' ? 'text-[#F97316]' : ''}`}
                    >
                      <path 
                        fillRule="evenodd" 
                  ...
                  <div className={`ms-3 ${activeContainer === 'attendance' ? 'text-[#F97316]' : ''}`}>Attendance</div>
                </button>
              </li>
              <li>
                <button 
                  onClick={() => handleContainerChange('addevent')} 
                  className={`w-[100%] flex items-center p-2 text-gray-900 rounded-r-lg hover:bg-orange-100 dark:hover:bg-gray-700 group ${activeContainer === 'addevent' ? 'bg-orange-100 text-[#F97316] border-l-4 border-[#F97316]' : ''}`}
                >
                  <span className={`w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-[#F97316] dark:group-hover:text-white`}>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"    className={`w-6 h-6 ${activeContainer === 'addevent' ? 'text-[#F97316]' : ''}`}>
  <path fill-rule="evenodd" d="M18.685 19.097A9.723 9.723 0 0 0 21.75 12c0-5.385-4.365-9.75-9.75-9.75S2.25 6.615 2.25 12a9.723 9.723 0 0 0 3.065 7.097A9.716 9.716 0 0 0 12 21.75a9.716 9.716 0 0 0 6.685-2.653Zm-12.54-1.285A7.486 7.486 0 0 1 12 15a7.486 7.486 0 0 1 5.855 2.812A8.224 8.224 0 0 1 12 20.25a8.224 8.224 0 0 1-5.855-2.438ZM15.75 9a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0Z" clip-rule="evenodd" />
</svg>

                  </span>
                  <div className={`ms-3 ${activeContainer === 'addevent' ? 'text-[#F97316]' : ''}`}>Add Event</div>
                </button>
              </li>
              <li>
                <button 
